    ...
    <div class="register-box text-center rounded">
        ...
        <form method="POST" action="{{route('register')}}">
            ...
            <div class="mb-3 text-start">
                ...
                <input type="password" id="konfirmasi-katasandi" class="form-control" name="password_confirmation"
                    placeholder="Masukkan Konfirmasi Kata Sandi" required autocomplete="new-password" required>
            </div>
            <div class="mb-4 text-start">
                ...
                <input type="number" id="phone" class="form-control @error('phone') is-invalid @enderror"
                    value="{{ old('phone') }}" name="phone" placeholder="Masukkan No. Telpon" required>
            </div>
